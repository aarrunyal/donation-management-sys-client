					...
					<div className="col-md-8 col-12">
						...
						<div className="card mt-2">
							<div className="card-body">
								...
								<div className="row">
									<div className="col-md-8  col-12">
										<h4 className="title text-dark">{state.name}</h4>
									</div>
							...
							<div className="card-body">
								<div className="d-grid gap-2 col-12 ">
									<a
										...
										className="btn  text-light btn-info shadow-0"
									>
										{' '}
										Donate{' '}
									</a>
											...
											<div className="d-flex mb-3">
												...
												<div className="info 1 mx-2">
													<a
														...
														onClick={() => getById(donation.id)}
													>
														{donation.name}
													</a>
													<strong className="text-dark">
														{' '}
														$ {helper.addZeroes(donation.expected_collection)}
													</strong>
												</div>
											</div>
										</>
						...
						<div className="card">
							<div className="card-body">
								<div className="tab-content" id="ex1-content">
									...
									>
										<p>
											{state.description ? Parser(state.description) : null}
										</p>
									</div>
								</div>
							</div>
