...
const Login = () => {
	...
	return (
		<div
			className="p-3 mb-2 bg-blue text-dark bg-opacity-20 min-vh-100 d-flex flex-row align-items-center"
					...
					<CRow className="justify-content-center">
						...
						<CCol md={6}>
							<CCardGroup>
								<CCard
									className="p-4"
									style={{ height: '555px', width: '900px' }}
								>
									<CCardBody>
										<CForm
											noValidate
										...
										>
											...
											<CRow>
												<CCol xs={6}>
													<CButton
														style={{
															backgroundColor: 'rgba(251,112,113,255)',
															border: 'none',
														}}
														className="w-100"
														type="submit"
